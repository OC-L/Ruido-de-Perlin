...
const rockColour = "#0A0A0A";
const sandColour = "#FFFFFF";
const grassColour = "#666666";
const forestColour = "#F3695F";
const seaColour = "#E38";
const seaColourSolid = "#E38";
const trunkColour = "#000000";
const leafColour = "#1A1A1A";
